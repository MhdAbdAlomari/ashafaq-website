...
export default function Contact() {
  const { dict } = useLang();
  return (
    <section id="contact" className="relative py-24 sm:py-28 lg:py-36 bg-white">
      <div className="max-w-5xl mx-auto px-5 sm:px-8">
        <motion.div
          ...
          className="relative overflow-hidden rounded-[1.75rem] sm:rounded-[2.5rem] p-8 sm:p-14 lg:p-20 text-center bg-[#0B1F3A] text-white shadow-[0_20px_60px_-30px_rgba(11,31,58,0.5)]"
        >
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute -top-32 -start-32 w-96 h-96 bg-[#1F5EFF] opacity-25 blur-3xl rounded-full" />
            <div className="absolute -bottom-32 -end-32 w-96 h-96 bg-[#1F5EFF] opacity-15 blur-3xl rounded-full" />
          </div>

          <div className="relative">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight leading-[1.15] pb-1 text-white">
              {dict.contact.title}
            </h2>
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs sm:text-sm text-white/85">
              <a
                href={CONTACT.mailto}
